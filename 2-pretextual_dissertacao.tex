...
\end{figure}
   ...
   \vfill
   \vspace{1cm}
    % \ABNTEXchapterfont\normalsize\bfseries\textsc{\MakeUppercase{Dissertação de Mestrado}}
   \vfill
   \vspace*{5cm}
...
\begin{fichacatalografica}
    ...
    \hspace{0.5cm}
	\imprimirtipotrabalho~--~Instituto Federal de Educação, Ciência e Tecnologia da Paraíba, Programa de Pós-Graduação em Tecnologia da Informação, João Pessoa, PB, \imprimirdata. \hfill 
...
% Gerada conforme instrucoes do PPGEE
  ...
  \vspace*{\fill}
    \begin{flushleft}
  	  Aprovado em 11 de Janeiro de 2020. \\
    \end{flushleft}
  \vspace*{\fill}
  ...
  \end{center}
   ...
   \assinatura{Prof. Dr. Nome Sobrenome -- IFPB \\ Avaliador}
   \assinatura{Prof. Dr. Nome Sobrenome -- UFPB \\ Avaliador Externo}
   \assinatura{Prof. Dr. Nome Sobrenome -- UFCG \\ Avaliador Externo}
